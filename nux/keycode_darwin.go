...
const (
	...
	Key_Return       KeyCode = 0x24       // kVK_Return
	Key_Tab          KeyCode = 0x30       // kVK_Tab
	Key_Space        KeyCode = 0x31       // kVK_Space
	Key_BackSpace    KeyCode = 0x33       // kVK_Delete
	...
	Key_Delete       KeyCode = 0x75       // kVK_ForwardDelete
	Key_Insert       KeyCode = 0x72       // kVK_Help
	Key_Help         KeyCode = 0x72       // kVK_Help
	...
	Key_Clear        KeyCode = 0x47       // kVK_ANSI_KeypadClear
	Key_ScrollLock   KeyCode = Key_Unknow // Unknow
	Key_Pause        KeyCode = Key_Unknow // Unknow
	Key_Snapshot     KeyCode = Key_Unknow // Unknow
